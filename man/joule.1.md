# joule(1) — Decentralized mesh supercomputer: pool idle GPUs into open-weight AI inference (Kimi-class)

## NAME

joule — Decentralized mesh supercomputer: pool idle GPUs into open-weight AI inference (Kimi-class)
